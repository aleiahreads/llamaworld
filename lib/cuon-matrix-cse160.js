...
class Vector3 {
    ...
    add(other) {
        ...
        let addend = other.elements;
        result[0] = result[0] + addend[0];
        result[1] = result[1] + addend[1];
        result[2] = result[2] + addend[2];
        return this;
    };
    ...
    sub(other) {
        ...
        // Don't delete the return statement.
        let result = this.elements;
        let subtractor = other.elements;
        result[0] = result[0] - subtractor[0];
        result[1] = result[1] - subtractor[1];
        result[2] = result[2] - subtractor[2];
        return this;
    };
    ...
    magnitude() {
        // Insert your code here.
        let v = this.elements;
        let m = Math.sqrt(Math.pow(v[0], 2) + Math.pow(v[1], 2) + Math.pow(v[2], 2))
        return m;
    };
